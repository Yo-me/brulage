 ...
 */
final class Version20210515133126 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE division (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE team (number INT NOT NULL, division_id INT DEFAULT NULL, PRIMARY KEY(number))');
